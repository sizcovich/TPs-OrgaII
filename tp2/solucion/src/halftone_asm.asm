...
.verAncho:
	...
	dec r13
.inicio:
	mov r10, r8 ;calculo la basura
	sub r10, r13
	;reseteo contador
    xor rbx, rbx

	sub r13, 16 ;resto para ver cuando llego al final
	add r15, r13 ;rdi +w- 16
	add r11, r13; rsi+w-16
...
.ultimaColumna: 
	mov rdi, r15 ;me pongo en w-16
	mov rsi, r11 ;me pongo en w-16
	mov rcx, 1
	jmp .ciclo
