...
waves_asm:
	.setup:
		...
		;rdx va a ser mi cuenta regresiva de filas
		;rax va a contar la columna en la que estoy
		xor rax, rax

		;Voy a fijarme 16 bits antes del row_size
		sub rcx, 16
	...
	.procesarFila:
		...
		add rax, 16	;Avanzo los 16 bytes

		cmp rax, rcx	;me fijo si me pase de la columna
		jl .procesarFila
		jge .avanzarColumna
